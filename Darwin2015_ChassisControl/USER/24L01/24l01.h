...
//SPI(NRF24L01)寄存器地址
#define CONFIG24L01     0x00  //配置寄存器地址;bit0:1接收模式,0发射模式;bit1:电选择;bit2:CRC模式;bit3:CRC使能;
...
#define NRF24L01_IRQ  (GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_8))

#define Set_NRF24L01_CE  {GPIO_SetBits(GPIOB,GPIO_Pin_9);}
#define Clr_NRF24L01_CE  {GPIO_ResetBits(GPIOB,GPIO_Pin_9);}

#define Set_NRF24L01_CSN  {GPIO_SetBits(GPIOB,GPIO_Pin_12);}
#define Clr_NRF24L01_CSN  {GPIO_ResetBits(GPIOB,GPIO_Pin_12);}
